...
const project = new awscdk.AwsCdkConstructLibrary({
  ...
  // CDK/jsii tests use enough memory that Jest's CPU-based default can exhaust WSL and CI workers.
...
- [ ] My pull request adheres to the [Pull Request Rule](https://github.com/open-constructs/aws-cdk-library/blob/main/CONTRIBUTING.md#pull-request)
  ...
  // },
  devDeps: ['@aws-cdk/integ-runner@2.205.3', `@aws-cdk/integ-tests-alpha@${cdkVersion}-alpha.0`],
  eslintOptions: {
    dirs: ['src', 'test'],
    prettier: true,
  },
